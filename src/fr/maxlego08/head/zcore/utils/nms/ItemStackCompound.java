...
public class ItemStackCompound {
    ...
    public Object getCompound(ItemStack itemStack) throws Exception {
        Object localItemStackObject = ItemStackUtils.EnumReflectionItemStack.CRAFTITEMSTACK.getClassz()
        ...
        return ItemStackUtils.EnumReflectionItemStack.NBTTAGCOMPOUND.getClassz().newInstance();
    }
    ...
    public ItemStack applyCompound(ItemStack itemStack, Object compoundObject) throws Exception {
        ...
        localItemStackObject.getClass()
                .getMethod(this.reflection.getMethodSetTag(),
                        new Class[]{ItemStackUtils.EnumReflectionItemStack.NBTTAGCOMPOUND.getClassz()})
                .invoke(localItemStackObject, compoundObject);

        return (ItemStack) ItemStackUtils.EnumReflectionItemStack.CRAFTITEMSTACK.getClassz()
                .getMethod("asBukkitCopy", new Class[]{ItemStackUtils.EnumReflectionItemStack.ITEMSTACK.getClassz()})
