package fr.maxlego08.head.zcore;
...
import fr.maxlego08.head.command.CommandManager;
import fr.maxlego08.head.inventory.VInventory;
import fr.maxlego08.head.inventory.ZInventoryManager;
import fr.maxlego08.head.listener.AdapterListener;
import fr.maxlego08.head.listener.ListenerAdapter;
import fr.maxlego08.head.zcore.logger.Logger;
import fr.maxlego08.head.zcore.logger.Logger.LogType;
import fr.maxlego08.head.zcore.utils.gson.LocationAdapter;
import fr.maxlego08.head.zcore.utils.gson.PotionEffectAdapter;
import fr.maxlego08.head.zcore.utils.plugins.Plugins;
import fr.maxlego08.head.zcore.utils.storage.NoReloadable;
...
public abstract class ZPlugin extends JavaPlugin {
    ...
    protected void preEnable() {
        ...
        this.commandManager = new CommandManager((HeadPlugin) this);
        this.inventoryManager = new ZInventoryManager((HeadPlugin) this);

        /* Add Listener */
        this.addListener(new AdapterListener((HeadPlugin) this));
