...
public abstract class VInventory extends ZUtils implements Cloneable {
	...
	protected InventoryResult preOpenInventory(HeadPlugin main, Player player, int page, Object... args)
	...
	public abstract InventoryResult openInventory(HeadPlugin main, Player player, int page, Object... args)
			throws InventoryOpenException;
	 ...
	 * @param player
	 */
	protected void onClose(InventoryCloseEvent event, HeadPlugin plugin, Player player) {
	}
	 ...
	 * @param player
	 */
	protected void onDrag(InventoryDragEvent event, HeadPlugin plugin, Player player) {
	}
