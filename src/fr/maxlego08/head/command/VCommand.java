package fr.maxlego08.head.command;
...
import fr.maxlego08.head.zcore.utils.commands.Arguments;
import fr.maxlego08.head.zcore.utils.commands.CollectionBiConsumer;
import fr.maxlego08.head.zcore.utils.commands.CommandType;
import fr.maxlego08.head.zcore.utils.commands.Tab;

public abstract class VCommand extends Arguments {

	protected final HeadPlugin plugin;
	 ...
	 * @param plugin
	 */
	public VCommand(HeadPlugin plugin) {
		super();
		this.plugin = plugin;
	}
	 ...
	 */
	protected abstract CommandType perform(HeadPlugin plugin);
